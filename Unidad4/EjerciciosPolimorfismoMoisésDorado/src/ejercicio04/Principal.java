...
public class Principal {
	...
	public static void main(String[] args) {
		...
		int tam=3;//Esta puesto 3 porque son los que tengo
		int op;
		
		Producto p1 = new Alimentacion (4.99, "Patatas Deluxe", 1, 30, 1);
		Producto p2 = new Alimentacion (1.99, "Peras", 3, 30, 2);
		Producto p3 = new Electronica (19.99, "Teclado", 2, 10);
		...
		do {
			...
			case 2:
				v.imprimirListado(); //NO me ha dado lugar, por eso no sale nada
			break;
